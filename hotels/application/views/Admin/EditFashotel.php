...
<html>
<head>
	<title>Ubah Data Fasilitas Hotel</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="margin: 4vh 5vh 0vh; border-radius: 15px;">
    ...
    <div class="content-wrapper" style="margin: 3vh 5vh 0vh;">
      <section class="content-header">
        <h3>Ubah Data Fasilitas Hotel</h3>
      </section>
    </div>
      ...
      <section class="content" style="margin: 2vh 5vh 0vh;">
        <div class="card" style="border-radius: 10px;">
          <div class="card-body">
            ...
            <?php foreach ($editfashotel as $key) : ?>

            <form class="row g-3" action="<?= base_url('Admin/SimpanEditFhotel/').'?id_fashotel='.$key->id_fashotel;?>" method="post">
              <div class="col-md-6">
                <label class="form-label">Nama Fasilitas</label>
                <input type="text" class="form-control" name="nama_fashotel" value="<?php echo $key->nama_fashotel?>">
              </div>
              ...
              <div class="col-md-6">
               ...
               <div class="col-md-6">
                ...
                <textarea class="form-control" name="keterangan" value="<?php echo $key->keterangan?>"><?php echo $key->keterangan?></textarea>
              </div>

              <div class="col-12 mt-4">
                <button type="submit" class="btn btn-primary">Save</button>
                <a href="<?= base_url('Admin/FasilitasHotel');?>" class="btn btn-danger">Cancel</a>
              </div>
            </form>
