      ...
      <section class="content" style="margin: 2vh 5vh 0vh;">
        <div class="card" style="border-radius: 10px;">
          <div class="card-body">
            ...
            <?php foreach ($editkamar as $key) : ?>

            <form class="row g-3" action="<?= base_url('Admin/SimpanEditkamar/').'?id_kamar='.$key->id_kamar;?>" method="post">
              <div class="col-md-6">
                <label class="form-label">Nama Room</label>
                <input type="hidden" name="id_kamar">
                <select class="form-select" aria-label="Default select example" name="nama_kamar">
                  <option value="<?php echo $key->nama_kamar?>" selected>Pilih Tipe Room</option>
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control" name="stok" value="<?php echo $key->stok?>">
              </div>
              <div class="col-md-6">
