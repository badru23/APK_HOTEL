...
<html>
<head>
	<title>Admin FasilitasHotel</title>
...
<body class="bg-light">
	...
	<div class="container-fluid"> 
      <nav class="navbar navbar-expand-lg navbar-dark bg-success" style="margin: 4vh 5vh 0vh; border-radius: 15px;">
    ...
    <div class="content-wrapper" style="margin: 3vh 5vh 0vh;">
      ...
      <section class="content" style="margin: 2vh 5vh 0vh;">
        <table class="table table-striped table-bordered" id="myTable">
          ...
          <?php foreach ($Fhotel as $key) : ?>
            <tr>
              <td width="250"><?php echo $key->nama_fashotel?></td>
              <td width="1000"><?php echo $key->keterangan?></td>
              <td width="100"><img src="<?php echo $key->gambar?>" style="height: 50px;"></td>
              <td width="130">
                <a class="btn btn-sm btn-primary" href="<?= base_url('Admin/Editfashotel/').'?id_fashotel='.$key->id_fashotel;?>">Ubah</a>
                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal<?= $key->id_fashotel?>">Hapus</button>   
              </td>
            </tr>

            <div class="modal fade" id="modal<?= $key->id_fashotel?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <a href="<?= base_url('Admin/Hapusfhotel/').'?id_fashotel='.$key->id_fashotel;?>" class="btn btn-warning">Hapus</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="d-flex justify-content-end" style="margin-right: 5vh;">
      <a href="<?= base_url('Admin/DataFhotel');?>" class="btn btn-primary"><i data-feather="plus-circle"></i></a>
    </div>
  </div>
