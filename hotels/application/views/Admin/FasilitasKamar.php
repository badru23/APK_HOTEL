...
<html>
<head>
	<title>Admin FasilitasKamar</title>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="margin: 4vh 5vh 0vh; border-radius: 15px;">
    ...
    <div class="content-wrapper" style="margin: 3vh 5vh 0vh;">
      ...
      <section class="content" style="margin: 2vh 5vh 0vh;">
        ...
        <?php foreach ($Fkamar as $key) : ?>
          
          <tr>
            <td><?php echo $key->nama_kamar?></td>
            <td><?php echo $key->nama_faskamar?></td>
            <td><?php echo $key->kategori?></td>
            <td><img src="<?php echo $key->gambar?>" style="height: 50px;"></td>
            <td width="130">
              <a class="btn btn-sm btn-primary" href="<?= base_url('Admin/Editfaskamar/').'?id_faskamar='.$key->id_faskamar;?>">Ubah</a>
              <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modal<?= $key->id_faskamar?>">Hapus</button>   
            </td>
          </tr>

          <div class="modal fade" id="modal<?= $key->id_faskamar?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a href="<?= base_url('Admin/Hapusfkamar/').'?id_faskamar='.$key->id_faskamar; ?>" class="btn btn-warning">Hapus</a>
                </div>
              </div>
            </div>
          </div>   
    ...
    <div class="d-flex justify-content-end" style="margin-right: 5vh;">
      <a href="<?= base_url('Admin/DataFkamar');?>" class="btn btn-primary"><i data-feather="plus-circle"></i></a>
    </div>
  </div>

  <div class="container-fluid">
    <footer class="footer" style="margin: 4vh 5vh 2vh;">    
