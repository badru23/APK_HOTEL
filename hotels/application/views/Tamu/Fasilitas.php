...
<div class="container">
    <div class="text-center" style="margin-top: 150px;">
     ...
     <div class="row" style="margin: 2vh 5vh 0vh;">

      <?php foreach ($fasilitas as $key) : ?>

        <div class="col-md-6">
          <div class="card mt-5" style="padding: 5px; border-radius: 10px;">
            <div class="card-body">
              <h5 class="card-title mb-4"><?php echo $key->nama_fashotel?></h5>
              <img src="<?php echo $key->gambar?>" style="width: 100%;">
              <a href="<?= base_url('Tamu/Detailfasilitas').'?id='.$key->id_fashotel;?>" class="btn btn-sm btn-warning mt-4">Lihat Detail</a>
            </div>
          </div>
        </div>
