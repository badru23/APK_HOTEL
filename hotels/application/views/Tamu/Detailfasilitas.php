...
<div class="container mt-5">
	...
	<div class="card mt-5" style="border-radius: 10px;">
	  <img src="<?php echo $key->gambar?>" class="card-img-top" style="height: 600px;">
	  <div class="card-body p-4">
	    <h5 class="card-title"><?php echo $key->nama_fashotel?></h5>
	    <p class="card-text"><?php echo $key->keterangan?></p>
	    <a href="<?= base_url('Tamu/Fasilitas');?>" class="btn btn-sm btn-warning">Kembali</a>
	  </div>
	</div>
